...
//--> Added
	...
	//$('.contact-wrap').css('background-image', 'url(' + imageSet[rnd] + ') no-repeat center center/cover;');

	$('.generic-bg').css("background-image", 'url(' + imageSet[rnd] +')').css("background-repeat", "no-repeat").css("background-size", "cover");
//--> End
	panoContent.show();
	$('.mountains-vid').hide();
	projectNav.show();
