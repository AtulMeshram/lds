...
$(document).ready(function() {
	...
	setTimeout(function(){
		...
		var openAboutUsContent = $('.js-show-about-us');
		var openServicesContent = $('.js-show-services');
		var openVRXContent = $('.js-show-VRX');
		...
		openAboutUsContent.on('click', function(e){
			thisNodeLink=$(this);
			openAboutUsContentOverlay();
		});

		openServicesContent.on('click', function(e){
			thisNodeLink=$(this);
			openServicesContentOverlay();
		});

		openVRXContent.on('click', function(e){
			thisNodeLink=$(this);
			openVRXContentOverlay();
		});


	}, 200);

	$('.js-play-home-showreel').on('click', function(e){
		$('.showreel-wrap').show();
		setTimeout(function(){
			$('.showreel-wrap').addClass('active');
        	homePlayer.playVideo();
		},10);
        
    });
    $('.js-close-home-showreel').on('click', function(e){
        $('.showreel-wrap').removeClass('active');
        setTimeout(function(){
			$('.showreel-wrap').hide();
	...
	openMap.on('click', function(e){
		iframeCode='<iframe class="pos-a-t-l full-size google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d235.5782369390814!2d72.80886707132989!3d19.14045256141015!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b60bd7af8c15%3A0x77d90f8366ac2489!2s301%2C+Yari+Rd%2C+Yagna+Nagar%2C+Versova%2C+Andheri+West%2C+Mumbai%2C+Maharashtra+400061!5e0!3m2!1sen!2sin!4v1490339309571"  frameborder="0" style="border:0" allowfullscreen></iframe>"'
	...
	$('.js-person').on('click', function(e){
		thisActive = $(this).attr('data-active');
		if (thisActive == 'true') {
	...
	$('.js-person').on('mouseleave', function(e){
		$(this).attr('data-active', 'false');
	});
...
if ($('.home').length) {
	...
	$('.main-nav li:nth-child(2) a').addClass('js-show-about-us');
...
// Added
	...
	$('.main-nav li:nth-child(3) a').addClass('js-show-services');
	$('.main-nav li:nth-child(3) a').attr('data-n', '1');
...
//--> Added
	...
	// imageSet[1] = "img/bg/bg_0.jpg";
	// imageSet[2] = "img/bg/bg_1.jpg";
	// imageSet[3] = "img/bg/bg_2.jpg";
	// imageSet[4] = "img/bg/bg_3.jpg";
	// imageSet[5] = "img/bg/bg_4.jpg";
	// imageSet[6] = "img/bg/bg_5.jpg";
	// imageSet[7] = "img/bg/bg_6.jpg";
	// var rnd = Math.floor( Math.random() * imageSet.length );
	// if( rnd == 0 ) {
	// 	rnd =1;
	// }

	$('.generic-bg').css("background-image", 'url(img/bg/home-panorama.jpg)').css("background-repeat", "no-repeat").css("background-size", "cover");
	continueAfterBGSet();
}

//--> Added
function openAboutUsContentOverlay() {
	$('.generic-bg').css("background-image", 'url(img/bg/about-us.jpg)').css("background-repeat", "no-repeat").css("background-size", "cover");
	continueAfterBGSet();
}

function openServicesContentOverlay() {
	$('.generic-bg').css("background-image", 'url(img/bg/services.jpg)').css("background-repeat", "no-repeat").css("background-size", "cover");
	continueAfterBGSet();
}

function openVRXContentOverlay() {
	$('.generic-bg').css("background-image", 'url(img/bg/vrx-portal.jpg)').css("background-repeat", "no-repeat").css("background-size", "cover");
	continueAfterBGSet();
}

function continueAfterBGSet(){
	panoContent.show();
	$('.mountains-vid').hide();
	projectNav.show();
	swapOverlayContent();
...
function siteLoaded(event) {
	...
	if (preloaderVidUnmask == true) {
		...
		setTimeout(function(){
			playVideoMask(fillScreenVid, 'true', 2000);
		}, 300);
	} else {
		$('.preloader').hide();
	}
